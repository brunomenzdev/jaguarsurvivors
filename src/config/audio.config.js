 ...
 * Audio Configuration
 * 
 * Contains all audio file paths for music, sound effects, and UI sounds.
 */
...
export const audioConfig = {
    ...
    slurp: 'src/assets/audio/slurp.mp3',
    uiclick: 'src/assets/audio/uiclick.mp3',
    knife: 'src/assets/audio/knife.mp3',
    ...
    explosion: 'src/assets/audio/explosion.mp3',
    miss: 'src/assets/audio/miss.mp3',
    magic: 'src/assets/audio/magic.mp3',
    boss: 'src/assets/audio/boss.mp3',
    purchase: 'src/assets/audio/purchase.mp3',
    kill: 'src/assets/audio/kill.mp3',
    popup: 'src/assets/audio/popup.mp3',
    spell: 'src/assets/audio/spell.mp3',
    levelcomplete: 'src/assets/audio/levelcomplete.mp3',
    gamestart: 'src/assets/audio/gamestart.mp3',
    menuclick: 'src/assets/audio/menuclick.mp3',
    valuecoin: 'src/assets/audio/valuecoin.mp3',
    bossdefeat: 'src/assets/audio/bossdefeat.mp3',
    goldcoin: 'src/assets/audio/goldcoin.mp3',
